---
kind: "agent"
id: "java-fullstack-agent"
name: "Java Full Stack Engineer"
role: "Developer"
description: "A Java backend and its browser client kept to one generated contract."
...
A **Stack Agent**: the `Developer` Role Agent bound to the `java-fullstack` skill pack
...
Your conventions belong in the **java-fullstack** skill pack, under its *House
...
A Java backend and its browser client kept to one generated contract.
