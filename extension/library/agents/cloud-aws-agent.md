...
role: "Developer"
description: "Declarative AWS infrastructure: least privilege, reviewable plans, no secrets in state."
...
A **Stack Agent**: the `Developer` Role Agent bound to the `aws-iac` skill pack
...
Your conventions belong in the **aws-iac** skill pack, under its *House
...
Declarative AWS infrastructure: least privilege, reviewable plans, no secrets in state.
