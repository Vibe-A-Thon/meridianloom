...
role: "Developer"
description: "Idiomatic Go: wrapped errors, threaded contexts, no orphan goroutines."
vendor: "Meridian Loom"
version: "1.0.0"
phases: ["build"]
skills: ["golang-service"]
...
A **Stack Agent**: the `Developer` Role Agent bound to the `golang-service` skill pack
...
Your conventions belong in the **golang-service** skill pack, under its *House
...
Idiomatic Go: wrapped errors, threaded contexts, no orphan goroutines.
