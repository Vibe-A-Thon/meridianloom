...
description: "Schema-first APIs: generated clients, compatible changes, stable errors."
vendor: "Meridian Loom"
version: "1.0.0"
phases: ["design", "build"]
skills: ["api-contract-first"]
...
A **Stack Agent**: the `Solution Architect` Role Agent bound to the `api-contract-first` skill pack
...
Your conventions belong in the **api-contract-first** skill pack, under its *House
...
Schema-first APIs: generated clients, compatible changes, stable errors.
