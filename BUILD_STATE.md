...
- **Current workstream:** N2 Workstream G — Product assurance; T33 adversarial regression corpus is the remaining buildable task
- **Current task:** T33 part 1 — corpus harness + first fixture batch (≥100 fixtures total, hosted execution vs passive observation tested separately, every block yields a usable evidence record, coverage limits documented, no general-resistance claim; FR-M46-09/10, SEC-34). T29 verified built (MV3-T04 PullRequestCard, 16 tests green). T30/T31/T32 dispositioned in DECISIONS.md (human-gated / multi-platform evidence blocked / elapsed-time soak).
