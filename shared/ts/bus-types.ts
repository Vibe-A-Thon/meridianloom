...
export interface EvidenceGateResult {
  ...
  "scope": Record<string, unknown>;
  /** total / required / gated / ungated counts and the story ids in scope. */
  "stories": Record<string, unknown>;
  /** The seven F2 measures, each {status, value, note, ...}. status is ok or unavailable — never a zero standing in for absent evidence. Two (provenanceQueriesRun, firstValueRetention) are structurally unrecordable and always read unavailable with the reason. */
  "measures": Record<string, unknown>;
  /** {verdict, reasons}. verdict is go | stop | pivot | kill | insufficient_evidence, applying the thresholds written in gaps_implementation.md §F2. insufficient_evidence is a real outcome of the gate. */
