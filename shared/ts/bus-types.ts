...
export interface TrustRejectionRateResult {
  ...
  /** FR-M37-01 (task 19): actionType -> bucket over every in-scope entry, where "rejected" generalises the F0 linked-rejection shape to entries whose own decision is rejected|reworked. */
