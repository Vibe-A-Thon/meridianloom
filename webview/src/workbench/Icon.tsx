export type IconName = 'overview' | 'delivery' | 'agents' | 'learning' | 'evidence' | 'runtime' | 'guide' | 'settings' | 'search' | 'plus' | 'arrow' | 'bell' | 'chevron' | 'check' | 'close' | 'focus' | 'menu' | 'play' | 'stop' | 'external' | 'spark' | 'layers';
const paths: Record<IconName, string> = {
  overview: 'M3 3h7v7H3z M14 3h7v7h-7z M3 14h7v7H3z M14 14h7v7h-7z',
  delivery: 'M4 4h16v16H4z M4 9h16 M9 9v11 M15 9v11',
  agents: 'M8 10a4 4 0 1 0 0-8 4 4 0 0 0 0 8 M1 21v-3a7 7 0 0 1 14 0v3 M16 3a4 4 0 0 1 0 8 M18 14a6 6 0 0 1 5 6',
  ...
  chevron: 'M9 5l7 7-7 7', check: 'M5 12l4 4L19 6', close: 'M6 6l12 12 M6 18 18 6',
  focus: 'M3 9V3h6 M15 3h6v6 M21 15v6h-6 M9 21H3v-6',
  menu: 'M3 6h18 M3 12h18 M3 18h18', play: 'M7 3l14 9-14 9z', stop: 'M5 5h14v14H5z',
